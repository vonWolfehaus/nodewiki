...
function commit(file, directory){
	...
	// create new git process which adds the file needed to be committed
	...
	git.on('exit', function(code){
		gitCommit = child_process.spawn('git', ['commit', '-m', 'vonwiki auto commit', file.name], {cwd: directory});
